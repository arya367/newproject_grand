...
use App\Model\Entity\PropertypeSublocation;
use Cake\ORM\Query;
...
/**
 * PropertypeSublocations Model
 */
class PropertypeSublocationsTable extends Table
{
    ...
    {
        $this->table('propertype_sublocations');
