<div class="siteplan">
<div class="sub_heading"><h2><?=stripslashes($projects[0]['site_heading']);?></h2></div>
<div class="locality"><img src="<?=SITE_PATH?>img/property/site_plan/<? print_r($projects[0]['site_image']);?>" class="img-responsive" alt="<? print_r($projects[0]['site_alt_tag']);?>" data-link="index:0"  /></div>
</div>
...
<ul data-elem="items">
<li><a href="<?=SITE_PATH?>img/property/site_plan/<? print_r($projects[0]['site_image']);?>"><img src="<?=SITE_PATH?>img/property/master_plan/<? print_r($projects[0]['site_image']);?>" alt="<? print_r($projects[0]['site_alt_tag']);?>"/></a></li>
</ul>
</div>
</div>
