<div class="number_plan">
<div class="sub_heading"><h2><?=stripslashes($projects[0]['numbering_heading']);?></h2></div>
<div class="locality"><img src="<?=SITE_PATH?>img/property/numbering_plan/<? print_r($projects[0]['numbering_image']);?>" class="img-responsive" alt="<? print_r($projects[0]['numbering_alt_tag']);?>" data-link="index:0"  /></div>
</div>
...
<ul data-elem="items">
<li><a href="<?=SITE_PATH?>img/property/numbering_plan/<? print_r($projects[0]['numbering_image']);?>"><img src="<?=SITE_PATH?>img/property/numbering_plan/<? print_r($projects[0]['numbering_image']);?>" alt="<? print_r($projects[0]['numbering_alt_tag']);?>"/></a></li>
</ul>
</div>
</div>
