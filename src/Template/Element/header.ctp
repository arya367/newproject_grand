...
<div class="container">
<a class="navbar-brand" href="<?=ROOT_PATH?>"><img src="<?=SITE_PATH?>images/logo.png" alt="YOO New Projects" class="img-fluid"></a>
...
<a class="nav-link dropdown-toggle" href="javascript:void(0);" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true">Projects </a>
<div class="dropdown-menu" aria-labelledby="navbarDropdown">
<?php echo  $this->cell('Common::homemenu');?>
<div class="dropdown-divider"></div>
<a class="dropdown-item" href="<?=SITE_PATH?>project/"> More Project</a>
</div>
</li>
