...
<div class="blg_title"><h2><a href="<?=SITE_PATH.'post/'?><?=$value['url']?>/"><?=$value['name']?></a></h2><div class="author"><i class="glyphicon glyphicon-user"></i> <a href="<?=SITE_PATH?>post/author/<?=$value['ausername']?>/"> <?=$value['aname']?></a></div></div></div>
<div class="blg_inner">
