...
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-4 col-xsmall"><div class="pr_img"><a href="<? echo SITE_PATH.'project/'.$data['url']; ?>/"><img src="<? echo SITE_PATH.'img/property/propertyimage/'.$data['property_image']; ?>" class="img-responsive" alt="<?=$data['property_image_alt_tag']?>"></a></div></div>
<div class="col-lg-8 col-md-8 col-sm-6 col-xs-8 col-xsmall"><div class="pr_det">
<div class="row">
<div class="col-lg-6 col-md-6 col-xs-7 col-xsmall"><div class="pr_heading"><h3><a href="<? echo SITE_PATH.'project/'.$data['url']; ?>/"><? echo $data['heading3'] ; ?></a></h3><div class="locality"><i class="fa fa-map-marker"></i> <?= strlen($data['sectorurl'])>4 ? $data['location_text'] : $data['location_text'] ?> <? echo ' ( '.ucwords($data['locatname']).' ) ' ; ?></div></div></div>
