...
<div class="row"><div class="col-lg-12 list_content"><h1><?=$title?></h1><?=$description; ?></div></div>
...
<div class="row"><div class="heading2"><h2><?=$heading2?></h2></div><div class="border_t"></div></div>
<div class="pr_con"><?= $this->fetch('content') ?></div></div></div></div></div></div>
...
var location="<?=SITE_PATH?>unitbylocations/searchProp/";
...
$.ajax({url:location+escape(params)+",<?=$locid?>,<?=$secid?>",dataType:"html",success:function(result){
$(".pr_con").html(result);
}});
});
