...
define('ROOT_PATH', 'http://'.$_SERVER['HTTP_HOST'].'/current/yoonewprojects.com/');
define('SITE_PATH', 'http://'.$_SERVER['HTTP_HOST'].'/current/yoonewprojects.com/');
define('CDN_PATH', 'http://'.$_SERVER['HTTP_HOST'].'/current/yoonewprojects.com/');
